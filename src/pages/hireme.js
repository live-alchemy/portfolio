...
const offerings = [
  { description: "Business Card Website", timeline: "1 week", price: "$150", example: "Flight of Phantoms" },
  { description: "Website w/ contact form", timeline: "2 weeks", price: "$275", example: "PoCake Landing" },
  ...
  { description: "Single Page App w/ Purchases", timeline: "4 weeks", price: "$600", example: "PoCake" },
...
const TableRow = ({ data }) => (
  <tr>
    ...
    <td>{data.price}</td>
    <td>
      <a alt={data.description} target="blank" rel="noopener noreferrer" href={data.link}>
        {data.example}
      </a>
    </td>
  </tr>
